...
const MenuButton = ({ text, onClick, to }: MenuButtonProps) => {
  return to ? (
    <div className="w-96 border-2 border-black hover:border-white">
      <Link
        to={to}
        className="flex w-full items-center justify-center rounded-none border-2 border-b-4 border-gray-300 border-b-gray-950/30 border-r-gray-950/30 bg-[#6E6E6E] bg-[url('./src/assets/stone.png')] bg-contain bg-repeat px-[1.2em] py-[0.6em] pb-0 font-minecraft text-base text-white antialiased bg-blend-exclusion hover:text-white"
